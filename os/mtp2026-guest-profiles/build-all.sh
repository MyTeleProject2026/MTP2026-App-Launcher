...
cat > "$MANIFEST" <<'EOF'
{
  ...
  "profiles": {
    ...
    "android": {"name":"MTP2026 Android OS","family":"Android-style","layout":"mobile","navigation":"gesture-or-three-button","imageKind":"mtp2026-owned-arm64-linux-profile","image":"android/mtp2026-android-arm64-linux.Image","initramfs":"android/mtp2026-android-initramfs.cpio.gz"},
