...
BROWSER_RUNTIME="${BUILD_ROOT}/out/browser-runtime"
...
cat > "$MANIFEST" <<'EOF'
{
  ...
  "osModel": {
    ...
    "note":"The four profiles reproduce the requested interaction families and system contracts without redistributing proprietary third-party firmware. The guest media is MTP2026-owned."
  },
  "applicationRuntime": {
  ...
  "guests": {
    ...
    "android": {"id":"android","name":"MTP2026 Android OS","architecture":"arm64","imageKind":"mtp2026-owned-arm64-linux-profile","imageRequired":true,"runtimeBackend":"qemu-aarch64-virt-or-native-qemu","bootProtocol":"linux-arm64-guest","installSlot":"android","runtimeSource":"mtp2026Arm64","profileFamily":"Android-style","profileLayout":"mobile","navigation":"gesture-or-three-button","accountProvider":"VexaAccount","appStore":"VexaStore","appRuntime":"webapp-registry-plus-host-package-installer"},
    "desktop": {"id":"desktop","name":"MTP2026 Desktop OS","architecture":"arm64","imageKind":"mtp2026-owned-arm64-linux-profile","imageRequired":true,"runtimeBackend":"qemu-aarch64-virt-or-native-qemu","bootProtocol":"linux-arm64-guest","installSlot":"desktop","runtimeSource":"mtp2026Arm64","profileFamily":"Desktop-style","profileLayout":"desktop","navigation":"taskbar","accountProvider":"VexaAccount","appStore":"VexaStore","appRuntime":"webapp-registry-plus-host-installer"},
